...
class SearchPage extends Component {
    ...
    render() {
        ...
        _.forEach(items, result => {
            result.image = result.image1_url !== undefined ? result.image1_url : getPath(result.image1, "ecommerce");
        ...
        items = _.orderBy(items, [property], [direction]);
            ...
            <div className="starter-template">
                ...
                <section className="section-content bg padding-y" id="top">
                    <div className="showOnPhone mb-4">
                        ...
                        <ModalSearchFilters categories={this.props.categories} tags={this.props.tags}  history={this.props.history}/>
                    </div>
                                ...
                                <div id="aside">
                                    <div className="card">
                                        <div className="card-body">
                                            <SearchFilters tags={this.props.tags} categories={this.props.categories} linkPrefix={""} history={this.props.history}/>
                                        </div>
                                    </div>
                                </div>
                            </aside>
